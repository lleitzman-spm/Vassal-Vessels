...
- [[A price is named]] — *its `consumes` names `knights` by id; this page names "Knights" literally*
- [[Charge!]] — *its `consumes` names `knights` by id; this page names "Knights" literally*
