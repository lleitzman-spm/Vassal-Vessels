...
- [[A House's Vessel]] — *this page names `readVessel`*
- [[A Seat at Court]] — *this page names `readSeat`*
- [[The Muster]] — *this page names `readHost`*
- [[The Year]] — *this page names `seasonAt`; this page names `SeasonId`*
- [[Turning]] — *this page names `computeTreachery`*

### guard

- [[Called anyway]] — *this page names `readWillingness`*
...
- [[His son expects it]] — *this page names `readSeat`*
- [[It starts to feel like his]] — *this page names `readSeat`*
- [[Ninety days pass]] — *this page names `seasonAt`; this page names `SeasonId`*
- [[The cup is empty]] — *this page names `readVessel`*
- [[The men are together]] — *this page names `HoldingRecord`*
